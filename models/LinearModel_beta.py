...
class LinearClassifierResNet_L(nn.Module):
    def __init__(self, layer=6, n_label=1000, pool_type='avg', width=1):
        super(LinearClassifierResNet_L, self).__init__()
        if layer == 1:
            pool_size = 8
            nChannels = 128 * width
            pool = pool_type
...
class LinearClassifierResNet_Lab(nn.Module):
    def __init__(self, layer=6, n_label=1000, pool_type='avg', width=1):
        super(LinearClassifierResNet_Lab, self).__init__()
        if layer == 1:
            pool_size = 8
            nChannels = 128 * width
            pool = pool_type
