...
CUDA_VISIBLE_DEVICES=8 python LinearProbing_beta.py --dataset cifar \
 --num_workers 9 \
 --data_folder ../data/myCIFAR-10-C/ \
 --save_path ./results/oracle/model_lc/ \
 --tb_path ./results/oracle/tb_lc/ \
 --model_path ./results/oracle/model/memory_nce_16384_resnet_ttt_lr_0.03_decay_0.0001_bsz_128_view_Lab_oracle_frost/ckpt_epoch_240.pth \
